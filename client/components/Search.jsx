			...
			<div className="row align-center">
				<div className="small-12 medium-4 columns">
					<div className="input-group">
						...
						<input ref="user" className="input-group-field" type="text" placeholder="Enter your name"/>
					</div>
				</div>
				<div className="small-12 medium-4 columns">
					<div className="input-group">
						<span className="input-group-label"><i className="fa fa-music"/></span>
						<input ref="query" className="input-group-field" type="text" placeholder="Enter a song"/>
					</div>
				</div>
