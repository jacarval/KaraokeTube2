...
export class Home extends Component {
	...
	renderVideoIfNotMobile() {
		if (!this.isMobile) {
			return <source src="dist/videos/discoball.mp4" type="video/mp4" />
		}
	}
	render() {
		return (
			<div className="home">
				<div className="fullscreen-video-bg">
					<video preload autoPlay loop className="cover">
						{this.renderVideoIfNotMobile()}
					</video>

				</div>
				<div className="landing">
					<Link className="button expanded show-for-medium" to="/player">Player</Link>
